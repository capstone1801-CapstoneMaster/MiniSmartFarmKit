...
var SearchPage = /** @class */ (function () {
    function SearchPage(navCtrl, navParams, items, afDB, alertCtrl) {
        var _this = this;
        ...
        this.afDB.object(this.plantsRef).valueChanges().subscribe(function (item) {
    ...
    SearchPage.prototype.getItems = function (ev) {
        ...
        this.afDB.list(this.plantsRef, function (ref) { return ref.orderByChild('Name').startAt(val); }).valueChanges().subscribe(function (Items) {
    ...
    SearchPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-search',template:/*ion-inline-start:"C:\Users\Owner\Desktop\capstone\last\test\src\pages\search\search.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{ \'SEARCH_TITLE\' | translate }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-searchbar (ionInput)="getItems($event)" placeholder="Search the Plants"></ion-searchbar>\n  <ion-list>\n    <button ion-item (click)="openItem(item.Name)" *ngFor="let item of currentItems">\n      <h2>{{item.Name}}</h2>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\Owner\Desktop\capstone\last\test\src\pages\search\search.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__providers_providers__["b" /* Items */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__providers_providers__["b" /* Items */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2_angularfire2_database__["a" /* AngularFireDatabase */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_angularfire2_database__["a" /* AngularFireDatabase */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]) === "function" && _e || Object])
    ], SearchPage);
    return SearchPage;
    var _a, _b, _c, _d, _e;
}());
